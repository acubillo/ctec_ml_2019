...
arbol_decision_predicciones_auc <- prediction(c(arbol_decision_predicciones), c(data_test$Requiere.atencion))
...
random_forest_predicciones_auc <- prediction(c(random_forest_predicciones), c(data_test$Requiere.atencion))
...
regresion_logistica_predicciones_auc <- prediction(c(regresion_logistica_predicciones), 
...
knn_predicciones_auc <- prediction(c(knn_predicciones), c(data_test$Requiere.atencion))
...
svm_predicciones_auc <- prediction(c(svm_predicciones), c(data_test$Requiere.atencion))
