...
autos_mse <- mse(mpg_prediction, autos_test_data$mpg)
autos_mse
```
...
# Se calcula el error cuadrático medio (mean-square error). 
autos_mse2 <- mse(mpg_prediction2, autos_test_data$mpg)
autos_mse2
```
...
# Se calcula el error cuadrático medio (mean-square error).
autos_mse_final <- mse(mpg_prediction_final, autos_test_data_final$mpg)
autos_mse_final
```
